...
@project_bp.route("/department/add", methods=['POST'])
@login_required
def add_department():
    ...
    return redirect(url_for('project.all_departments'))

@project_bp.route("/department/edit/<int:id>", methods=['GET', 'POST'])
@login_required
...
@project_bp.route("/department/delete/<int:id>", methods=['POST'])
@login_required
